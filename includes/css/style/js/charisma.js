$(document).ready(function () {
    ...
    //            $.ajax({
    //                url: "../SearchCustomer.asmx/SearchCustomerList",
    ...
    //                },
    //                error: function (data) {
    //                    alert("Oops, could not load the data, try after some time !");
    //                }
    //            });
    //        },
    //        minLength: 2
    ...
    $("#cid").change(function () {
        $.ajax({
            type: "POST",
            url: "../SearchCustomer.asmx/getDetail",
            data: "{ 'customerdetail': '" + request.term + "' }",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
