					...
					<div class="col-lg-7">
						<div class="ibox">
							...
							<div class="ibox-content">
								<form method="POST" action="<?php echo base_url()?>index.php/home/saveContact" class="form-horizontal" enctype="multipart/form-data">																	
									<div class="form-group">
										<label class="col-sm-4 control-label">Address</label>
										<div class="col-sm-8">
											<textarea name="cAddress" id="cAddress" class="form-control txtcls" required></textarea>
										</div>
									</div>
									...
									<div class="hr-line-dashed"></div>													
									<div class="form-group">
										<label class="col-sm-4 control-label">Google Map Ifram</label>
										<div class="col-sm-8">
											<textarea name="cLatlang" id="cLatlang" class="form-control" rows="10" required /></textarea>
										</div>
									</div>
