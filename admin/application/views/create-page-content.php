				...
				<div class="col-lg-12">
					<div class="ibox">							
						<div class="ibox-content">
							<form method="POST" action="<?php echo base_url()?>index.php/home/savepagescontent" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea name="content_desc" id="content_desc" class="form-control txtcls"></textarea>
									</div>
								</div>
								<div class="hr-line-dashed"></div>
