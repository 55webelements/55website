					...
					<div class="col-lg-12">
						<div class="ibox">
							...
							<div class="ibox-content">
								<form method="POST" action="<?php echo base_url()?>index.php/home/updateBlog" class="form-horizontal" enctype="multipart/form-data">
							
									<div class="form-group">
										<label class="col-sm-2 control-label">Title</label>
										<div class="col-sm-8">
											<textarea name="bTitle" id="bTitle" class="form-control" required /><?php echo @$item[0]->bTitle;?></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea rows="5" name="bDesc" id="bDesc" class="form-control txtcls" required><?php echo @$item[0]->bDesc;?></textarea>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									<div class="form-group">
										...
										{
										?>
										<img src="<?php echo base_url('uploads/files/'.$item[0]->bImage);?>" style="width:200px;" />
										<?php
										}
										?>
