				...
				<div class="col-lg-7">
					<div class="ibox">
						...
						<div class="ibox-content">
							<form method="POST" action="<?php echo base_url()?>index.php/home/saveBanner" class="form-horizontal" enctype="multipart/form-data">
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea name="bDesc" id="bDesc" class="form-control" required></textarea>
									</div>
								</div>
								<div class="hr-line-dashed"></div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<input type="file" accept="image/*" name="bImage" id="bImage" class="form-control" required >
										<!--<span id="cond" style="color: red;font-size:13px;">*Banner Width and Height should be 2000 X 1000px.</span>-->
									</div>
								</div>
								<div class="hr-line-dashed"></div>
