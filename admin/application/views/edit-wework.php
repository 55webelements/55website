	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-sm-8">
			...
			<ol class="breadcrumb">
				...
				<li class="active">
					<strong>Edit How We Work?</strong>
				</li>
			</ol>
		</div>
					...
					<div class="col-lg-7">
						<div class="ibox">
							...
							<div class="ibox-content">
								<form method="POST" action="<?php echo base_url()?>index.php/home/updateWework" class="form-horizontal" enctype="multipart/form-data">																	
									<div class="form-group">
										<label class="col-sm-4 control-label">Title</label>
										<div class="col-sm-8">
											<input type="text" name="wTitle" id="wTitle" class="form-control" value="<?php echo @$item[0]->wTitle;?>" required />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea name="wDesc" id="wDesc" class="form-control txtcls" required><?php echo @$item[0]->wDesc;?></textarea>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									...
									<div class="form-group">
										...
										<?php
											...
											{
										?>
											<img src="<?php echo base_url('uploads/files/'.@$item[0]->wImage);?>" style="width:200px;" />
										<?php	
											}
										?>
											<input type="file" name="wImage" id="wImage" class="form-control" />
											<input type="hidden" name="hiddenwImage" id="hiddenwImage" value="<?php echo @$item[0]->wImage;?>" />
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="altTitle" name="altTitle" id="altTitle" class="form-control" value="<?php echo @$item[0]->altTitle;?>"/>
										</div>
									</div>
									<div class="hr-line-dashed"></div>			
