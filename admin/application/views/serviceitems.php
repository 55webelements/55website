...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-sm-4">
			<h2><?php echo @ucwords($service[0]->sTitle);?> - Services</h2>
			<ol class="breadcrumb">
				<li>
		...
		<div class="col-sm-4 pull-right">
			<h2>
				<a href="<?php echo base_url()?>index.php/home/createServiceItem/<?php echo @$serviceid;?>" class="btn btn-w-m btn-primary pull-right">Add Service Item</a>
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								<thead>
									<tr>
										...
										<th class="center" style="width:25%;">Title</th>
										<th class="center" style="width:25%;">Description</th>
										<th class="center" style="width:20%;">Image</th>				
										<th class="center" style="width:10%;">Page Content</th>				
								...
								?>
									<tr class="gradeX">
										...
										<td class="center">
											<?php echo @$items[$i]->sTitle;?>
										</td>
										<td class="center">
											<?php echo @$items[$i]->sDesc;?>
										</td>
										<td class="center">
											<img src="<?php echo base_url();?>uploads/services/<?php echo @$items[$i]->sImage;?>" style="widht:200px;" />
										</td>
										<td>
											<a href="<?php echo base_url()?>index.php/home/viewServiceItemContent/<?php echo @$items[$i]->id;?>/<?php echo @$serviceid;?>"><i class="fa fa-eye"></i> View/Add </a>
										</td>
										<td class="center" style="width:12%;">
											<a href="<?php echo base_url()?>index.php/home/editServiceItem/<?php echo @$items[$i]->id;?>/<?php echo @$serviceid;?>"><i class="fa fa-edit"></i></a>
											&nbsp; | &nbsp;
											<a href="<?php echo base_url()?>index.php/home/deleteServiceItem/<?php echo @$items[$i]->id;?>/<?php echo @$serviceid;?>"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php
									}
