...
<div class="row wrapper border-bottom white-bg page-heading">
	<div class="col-sm-8">
		...
		<ol class="breadcrumb">
			...
			<li>
				<a href="<?php echo base_url()?>"><?php echo @$pageName[0]->page_title;?> - Content</a>
			</li>
			<li class="active">
	...
	<div class="col-sm-4 pull-right">
		<h2>
			<a href="<?php echo base_url()?>index.php/home/pagescontent/<?php echo @$pageId;?>" class="btn btn-w-m btn-default pull-right">Back to List</a>
		</h2>
	</div>
</div>
<div class="row">
				...
				<div class="col-lg-12">
					<div class="ibox">
						...
						<div class="ibox-content">
							...
							<form method="POST" action="<?php echo base_url()?>index.php/home/updatepagescontent" class="form-horizontal" enctype="multipart/form-data">
							
								<div class="form-group">
									<label class="col-sm-2 control-label">Title</label>
									<div class="col-sm-8">
										<input type="text" name="content_title" id="content_title" class="form-control" required value="<?php echo @$info[0]->content_title;?>"/>
									</div>
								</div>
								...
								<div class="form-group">
									...
									<div class="col-sm-8">
										<textarea name="content_desc" id="content_desc" class="form-control txtcls" required><?php echo @$info[0]->content_desc;?></textarea>
									</div>
								</div>
								<div class="hr-line-dashed"></div>
