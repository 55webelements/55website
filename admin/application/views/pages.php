...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		...
		<div class="col-sm-4 pull-right">
			<h2>
				<a href="<?php echo base_url()?>index.php/home/createPage" class="btn btn-w-m btn-primary pull-right">Add New Page</a>
			</h2>
		</div>
	</div>
	<div class="row">
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								...
								?>
									<tr class="gradeX">
										...
										<td class="center"><?php echo @$items[$i]->pTitle;?></td>
										<td class="center">
										<?php 
										echo @$items[$i]->seoCustomURL;
										?>
										</td>
										<td class="center"><?php echo @$items[$i]->metaTitle;?></td>
										<td class="center"><?php echo @$items[$i]->metaDesc;?></td>
										<td class="center" width="35%"><?php echo @$items[$i]->metaKeys;?></td>
										
										<td class="center">
											<a href="<?php echo base_url()?>index.php/home/editPage/<?php echo @$items[$i]->id;?>"><i class="fa fa-edit"></i></a> <!--&nbsp; | &nbsp;
