...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-sm-6">
			<h2><?php echo @ucwords($service[0]->sTitle);?> - <?php echo @ucwords($serviceitem[0]->sTitle);?> - Content</h2>
			<ol class="breadcrumb">
				<li>
		...
		<div class="col-sm-4 pull-right">
			<h2>
				<a href="<?php echo base_url()?>index.php/home/viewServiceItems/<?php echo @$serviceid;?>" class="btn btn-w-m btn-default pull-right" style="margin-left:10px;">Back to List</a>
			</h2>
			<h2>
			
				<a href="<?php echo base_url()?>index.php/home/createServiceItemContent/<?php echo @$itemid;?>/<?php echo @$serviceid;?>" class="btn btn-w-m btn-primary pull-right">Add Content</a>
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								<thead>
									<tr>
										...
										<th class="center" style="width:12%;">Actions</th>
									</tr>
								</thead>
								<tbody>
								<?php
								...
								?>
									<tr class="gradeX">
										...
										<td class="center">
											<?php echo @$items[$i]->sDesc;?>
										</td>
										<td class="center">
											<img src="<?php echo base_url();?>uploads/services/<?php echo @$items[$i]->sImage;?>" style="widht:150px;" />
										</td>
										
										<td class="center" style="width:12%;">
											<a href="<?php echo base_url()?>index.php/home/editServiceItemContent/<?php echo @$items[$i]->id;?>/<?php echo @$itemid;?>/<?php echo @$serviceid;?>"><i class="fa fa-edit"></i></a>
											&nbsp; | &nbsp;
											<a href="<?php echo base_url()?>index.php/home/deleteServiceItemContent/<?php echo @$items[$i]->id;?>/<?php echo @$itemid;?>/<?php echo @$serviceid;?>"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php
									}
