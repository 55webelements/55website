					...
					<div class="col-lg-7">
						<div class="ibox">
							...
							<div class="ibox-content">
								<form method="POST" action="<?php echo base_url()?>index.php/home/saveTestimonial" class="form-horizontal" enctype="multipart/form-data">
							
									
									<div class="form-group">
										<label class="col-sm-4 control-label">Message</label>
										<div class="col-sm-8">
											<textarea name="tTitle" id="tTitle" class="form-control" required></textarea>
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea name="altTitle" id="altTitle" class="form-control"></textarea>
										</div>
									</div>
									<div class="hr-line-dashed"></div>
