...
<div class="row wrapper border-bottom white-bg page-heading">
	...
	<div class="col-sm-4 pull-right">
		<h2>
			<a href="<?php echo base_url()?>index.php/home/aboutus" class="btn btn-w-m btn-default pull-right">Back to List</a>
		</h2>
	</div>
</div>
<div class="row">
				...
				<div class="col-lg-12">
					<div class="ibox">
						...
						<div class="ibox-content">
							...
							<form method="POST" action="<?php echo base_url()?>index.php/home/updateaboutus" class="form-horizontal" enctype="multipart/form-data">
