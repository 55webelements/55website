...
<link href="<?php echo base_url()?>externals/css/plugins/summernote/summernote-bs3.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-sm-8">
			<h2><?php echo @ucwords($service[0]->sTitle);?> - <?php echo @ucwords($serviceitem[0]->sTitle);?> - Add Content</h2>
			<ol class="breadcrumb">
				<li>
					...
					<div class="col-lg-12">
						<div class="ibox">
							...
							<div class="ibox-content">
								<form method="POST" action="<?php echo base_url()?>index.php/home/saveServiceItemContent/<?php echo @$itemid;?>/<?php echo @$serviceid;?>" class="form-horizontal" enctype="multipart/form-data">	
								
									<div class="form-group">
										<label class="col-sm-2 control-label">Full Description</label>
										<div class="col-sm-10">
											<textarea name="sDesc" id="sDesc" class="form-control txtcls" rows="5" required></textarea>
										</div>
									</div>
