...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		...
		<div class="col-sm-4 pull-right">
			<h2>
				<a href="<?php echo base_url()?>index.php/home/createContact" class="btn btn-w-m btn-primary pull-right">Add Details</a>
			</h2>
		</div>
	</div>
	<div class="row">
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								...
								?>
									<tr class="gradeX">
										...
										<td class="center"><?php echo @$items[$i]->cAddress;?></td>
										<td class="center"><?php echo @$items[$i]->cEmail;?></td>
										<td class="center"><?php echo @$items[$i]->cContact;?></td>
										
										<td class="center">
											<a href="<?php echo base_url()?>index.php/home/editContact/<?php echo @$items[$i]->id;?>"><i class="fa fa-edit"></i></a> 
										</td>
									</tr>
								<?php
									}
