	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-sm-8">
			...
			<ol class="breadcrumb">
				...
				<li class="active">
					<strong>Add Career Content</strong>
				</li>
			</ol>
		</div>
					...
					<div class="col-lg-7">
						<div class="ibox">
							...
							<div class="ibox-content">
								<form method="POST" action="<?php echo base_url()?>index.php/home/saveCareer" class="form-horizontal" enctype="multipart/form-data">																	
									<div class="form-group">
										<label class="col-sm-4 control-label">Career Description</label>
										<div class="col-sm-8">
											<textarea name="cDesc" id="cDesc" class="form-control" required></textarea>
										</div>
									</div>
