...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		...
		<div class="col-sm-4 pull-right">
			...
			{
			?>
				<a href="<?php echo base_url()?>index.php/home/createWework" class="btn btn-w-m btn-primary pull-right">Add Item</a>
			<?php
			}
			?>
			</h2>
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								...
								?>
									<tr class="gradeX">
										...
										<td class=""><?php echo @$items[$i]->wDesc;?></td>
										<td class=""><?php echo @$items[$i]->altTitle;?></td>
										<td>
											<img src="<?php echo base_url('uploads/files/'.@$items[$i]->wImage);?>" style="width:200px;" />
										</td>
										<td class="center">
											<a href="<?php echo base_url()?>index.php/home/editWework/<?php echo @$items[$i]->id;?>"><i class="fa fa-edit"></i></a> &nbsp; | &nbsp;
											<a href="<?php echo base_url()?>index.php/home/deleteItemWithImage/<?php echo @$items[$i]->id;?>/wework/wImage/files/wework"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php
									}
