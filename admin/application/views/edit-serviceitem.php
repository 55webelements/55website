	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-sm-8">
			<h2><?php echo @ucwords($service[0]->sTitle);?> - Edit Item</h2>
			<ol class="breadcrumb">
				<li>
				...
				<li class="active">
					<strong>Edit Service Item</strong>
				</li>
			</ol>
		</div>
					...
					<div class="col-lg-7">
						<div class="ibox">
							...
							<div class="ibox-content">
								<form method="POST" action="<?php echo base_url()?>index.php/home/updateServiceItem/<?php echo @$serviceid;?>" class="form-horizontal" enctype="multipart/form-data">																	
									<div class="form-group">
										<label class="col-sm-4 control-label">Service Name</label>
										<div class="col-sm-8">
											<input type="text" name="sTitle" id="sTitle" class="form-control" value="<?php echo @$item[0]->sTitle;?>" required />
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea name="sDesc" id="sDesc" class="form-control" rows="5" required><?php echo @$item[0]->sDesc;?></textarea>
										</div>
									</div>
									<div class="hr-line-dashed"></div>														
									<div class="form-group">
										...
										{
										?>
										<img src="<?php echo base_url();?>uploads/services/<?php echo @$item[0]->sImage;?>" style="width:300px;" /><br />
										<?php
										}										
										?>
											<input type="file" name="sImage" id="sImage" class="form-control"  />
											<input type="hidden" name="hiddensImage" id="hiddensImage" value="<?php echo @$item[0]->sImage;?>" />
										</div>
									</div>
									<div class="hr-line-dashed"></div>													
									<div class="form-group">
										...
										{
										?>
										<img src="<?php echo base_url();?>uploads/services/<?php echo @$item[0]->sBanner;?>" style="width:300px;" /><br />
										<?php
										}										
										?>
											<input type="file" name="sBanner" id="sBanner" class="form-control"  />
											<input type="hidden" name="hiddensBanner" id="hiddensBanner" value="<?php echo @$item[0]->sBanner;?>" />
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="seoCustomURL" id="seoCustomURL" value="<?php echo @$item[0]->seoCustomURL;?>" class="form-control" required />
										</div>
									</div>
									<div class="hr-line-dashed"></div>
