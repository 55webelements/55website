...
<link href="<?php echo base_url()?>externals/css/plugins/dataTables/dataTables.tableTools.min.css" rel="stylesheet">
	<div class="row wrapper border-bottom white-bg page-heading">
		...
		<div class="col-sm-4 pull-right">
			...
			{
			?>
				<a href="<?php echo base_url()?>index.php/home/createService" class="btn btn-w-m btn-primary pull-right">Add Service</a>
			<?php
			}
			?>
			</h2>
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								...
								?>
									<tr class="gradeX">
										...
										<td class="center">
											<a href="<?php echo base_url()?>index.php/home/viewServiceItems/<?php echo @$items[$i]->id;?>">View</a>
										</td>
										<td class="center" style="width:12%;">
											<a href="<?php echo base_url()?>index.php/home/editService/<?php echo @$items[$i]->id;?>"><i class="fa fa-edit"></i></a>
<!--											&nbsp; | &nbsp;
