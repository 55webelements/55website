...
<link href="<?php echo base_url()?>externals/css/plugins/summernote/summernote-bs3.css" rel="stylesheet">
	...
	<div class="row wrapper border-bottom white-bg page-heading">
		<div class="col-sm-8">
			<h2><?php echo @ucwords($aType);?> - Edit Content</h2>
			<ol class="breadcrumb">
				<li>
					...
					<div class="col-lg-7">
						<div class="ibox">
							...
							<div class="ibox-content">
								<form method="POST" action="<?php echo base_url()?>index.php/home/updateAboutItem/<?php echo @$aType;?>" class="form-horizontal" enctype="multipart/form-data">																	
									<?php
									if(@$aType == 'process')
									{
									?>
									<div class="form-group">
										...
										<div class="col-sm-8">
											<input type="text" name="aTitle" id="aTitle" value="<?php echo @$item[0]->aTitle;?>" class="form-control" required />
										</div>
									</div>
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											...
											{
											?>
												<img src="<?php echo base_url();?>uploads/files/<?php echo @$item[0]->aIcon;?>" style="width:50px;" /><br />
											<?php
											}
											?>
											<input type="file" name="aIcon" id="aIcon" class="form-control" />
											<input type="hidden" name="hiddenaIcon" id="hiddenaIcon" value="<?php echo @$item[0]->aIcon;?>" />
										</div>
									</div>
									<div class="hr-line-dashed"></div>
									<?php
									...
									<div class="form-group">
										...
										<div class="col-sm-8">
											<textarea name="aDesc" id="aDesc" class="txtcls form-control" rows="8"><?php echo @$item[0]->aDesc;?></textarea>
										</div>
									</div>
