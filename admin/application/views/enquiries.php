			...
			<div class="wrapper wrapper-content">
				<div class="row">
					<div class="ibox">                        
						...
						<?php
						if(@$this->session->userdata("esuc") != '')
						{
						?>
							<div class="alert alert-success alert-dismissable">
                                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                <?php
								echo @$this->session->userdata("esuc");
								@$this->session->unset_userdata("esuc");
								?>
                            </div>
						<?php
						}
						if(@$this->session->userdata("efail") != '')
						{
						?>
							<div class="alert alert-danger alert-dismissable">
                                <button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
                                <?php
								echo @$this->session->userdata("efail");
								@$this->session->unset_userdata("efail");
								?>
                            </div>
						<?php
						}
							...
							<table class="table table-striped table-bordered table-hover " id="editable" >
								<thead>
									<tr>
										...
										<th class="center" style="width:22%">Message</th>											
								...
								?>
									<tr class="gradeX">
										...
										<td class="center"><?php echo @ucwords($items[$i]->cName);?></td>
										<td class="center"><?php echo @ucwords($items[$i]->cMobile);?></td>
										<td class="center"><?php echo @ucwords($items[$i]->cEmail);?></td>
										<td class="center"><?php echo @ucwords($items[$i]->cMessage);?></td>
										<td class="center">
											<a href="<?php echo base_url()?>index.php/home/deleteEnquiry/<?php echo @$items[$i]->id;?>"><i class="fa fa-trash"></i></a>
										</td>
									</tr>
								<?php
									}
