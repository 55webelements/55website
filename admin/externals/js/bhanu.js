...
$(function(){
	$("#mainCat").change(function(){
		...
		urlpath = baseurl+"index.php/catalogues/createProduct/"+categoryID;
		window.location.href=urlpath;		
	});
});
...
$(function(){
	$("#subcatId").change(function(){
		...
		urlpath = baseurl+"index.php/catalogues/createProduct/"+categoryID+"/"+subcategoryID;
		//alert(urlpath)
		window.location.href=urlpath;
	});
});
...
$(function(){
	$("#tejaBhanu").change(function(){		
		...
		//alert(productid);
		//alert(categoryID);
		urlpath = baseurl+"index.php/catalogues/editProduct/"+productid+"/"+categoryID;
		window.location.href=urlpath;
	});
});
...
$(function(){
	$("#subcatId1").change(function(){
		...
		var subcategoryID = $(this).val();
		urlpath = baseurl+"index.php/catalogues/editProduct/"+productid+"/"+categoryID+"/"+subcategoryID;
		//alert(urlpath)
		window.location.href=urlpath;
	});
});
